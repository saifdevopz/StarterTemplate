...
#pragma warning restore IDE0060 // Remove unused parameter
    ...
    private async Task SeedInitialData()
    {
        ...
        for (int i = 0; i < totalRecords; i++)
        {
            ...
            await writer.WriteAsync(typeof(OrderCreatedIntegrationEventScale).FullName, NpgsqlDbType.Varchar);
            await writer.WriteAsync(
                JsonSerializer.Serialize(new OrderCreatedIntegrationEventScale(Guid.NewGuid())), NpgsqlDbType.Jsonb);
