...
internal static class DataShapingService
{
    private static readonly ConcurrentDictionary<Type, PropertyInfo[]> PropertiesCache = new();

    public static ExpandoObject ShapeData<T>(T entity, string? fields)
    {
    ...
    public static List<ExpandoObject> ShapeCollectionData<T>(
    ...
    public static bool Validate<T>(string? fields)
    {
        ...
        return fieldsSet.All(f => Array.Exists(propertyInfos, p => p.Name.Equals(f, StringComparison.OrdinalIgnoreCase)));
    }
}
